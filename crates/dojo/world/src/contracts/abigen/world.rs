...
impl cainome::cairo_serde::CairoSerde for Event {
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            18usize => Ok(Event::StoreUpdateMembers(
                StoreUpdateMembers::cairo_deserialize(__felts, __offset + 1)?,
            )),
            19usize => Ok(Event::StoreDelRecord(StoreDelRecord::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            20usize => Ok(Event::WriterUpdated(WriterUpdated::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            21usize => Ok(Event::OwnerUpdated(OwnerUpdated::cairo_deserialize(
                __felts,
                __offset + 1,
            )?)),
            _ => {
...
impl cainome::cairo_serde::CairoSerde for Resource {
    ...
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        match __rust {
            ...
            Resource::World => usize::cairo_serialize(&5usize),
            Resource::Unregistered => usize::cairo_serialize(&6usize),
            Resource::Library(val) => {
                let mut temp = vec![];
                temp.extend(usize::cairo_serialize(&7usize));
                temp.extend(<(
    ...
    fn cairo_deserialize(
        ...
        match __index as usize {
            ...
            3usize => Ok(Resource::ExternalContract(<(
                cainome::cairo_serde::ContractAddress,
                starknet::core::types::Felt,
            )>::cairo_deserialize(
                __felts, __offset + 1
            )?)),
            4usize => Ok(Resource::Namespace(
                cainome::cairo_serde::ByteArray::cairo_deserialize(__felts, __offset + 1)?,
            )),
            5usize => Ok(Resource::World),
            6usize => Ok(Resource::Unregistered),
            7usize => Ok(Resource::Library(<(
                cainome::cairo_serde::ClassHash,
                starknet::core::types::Felt,
            )>::cairo_deserialize(
                __felts, __offset + 1
